# Python wrapper for motion controller drivers

This project is aiming to develop a standard API to interface motion controllers to Python programs. Initially it only
supports a subset of the instructions supported by the Standa 8SMC1-USB stepper motor controller.
...
[ramezquitao@cihologramas.com](mailto:ramezquitao@cihologramas.com)
